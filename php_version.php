 ...
 */
    ...
    class php_versionPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('TitlePhpVersion');
            $this->SetMenuLabel('LabelPhpVersion');
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'version', 'version', 'caption_version'),
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            $column = new TextViewColumn('version', 'version', 'caption_version', $this->dataset);
            $column->SetOrderable(true);
            $column->setAlign('left');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('header_hint_version');
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            $column->SetFullTextWindowHandlerName('php_version_description_handler_list');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('php_version_description_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        ...
        protected function AddPrintColumns(Grid $grid)
        {
            ...
            $column->setAlign('left');
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('php_version_description_handler_print');
            $grid->AddPrintColumn($column);
        ...
        protected function AddExportColumns(Grid $grid)
        {
            ...
            $column->setAlign('left');
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('php_version_description_handler_export');
            $grid->AddExportColumn($column);
        ...
        private function AddCompareColumns(Grid $grid)
        {
            ...
            $column->setAlign('left');
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('php_version_description_handler_compare');
            $grid->AddCompareColumn($column);
        ...
        protected function CreateGrid()
        {
            ...
            $this->SetViewFormTitle('%version%');
            $this->SetEditFormTitle('%version%');
        ...
        protected function doRegisterHandlers() {
            ...
            $column->SetOrderable(true);
            $column->setAlign('left');
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'php_version_description_handler_list', $column);
            ...
            $column->SetOrderable(true);
            $column->setAlign('left');
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'php_version_description_handler_print', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column->SetOrderable(true);
            $column->setAlign('left');
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'php_version_description_handler_compare', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('description', 'description', 'caption_description', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'php_version_description_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    try
    {
        $Page = new php_versionPage("php_version", "php_version.php", GetCurrentUserPermissionSetForDataSource("php_version"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("php_version"));
