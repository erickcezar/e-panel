 ...
 */
    ...
    class paramPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->SetMenuLabel('LabelParameter');
    ...
    try
    {
        $Page = new paramPage("param", "param.php", GetCurrentUserPermissionSetForDataSource("param"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("param"));
