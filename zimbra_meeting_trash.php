 ...
 */
    ...
    class zimbra_meeting01Page extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('TitleZimbraMeetingTrash');
            $this->SetMenuLabel('LabelZimbraMeetingTrash');
            ...
            $this->dataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), '(`zimbra_meeting`.`deleted` = 1)'));
        }
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'floor', 'floor', 'Floor'),
                new FilterColumn($this->dataset, 'building', 'building', 'Building'),
                new FilterColumn($this->dataset, 'city', 'city', 'City'),
                new FilterColumn($this->dataset, 'state', 'state', 'State'),
                new FilterColumn($this->dataset, 'postal_code', 'postal_code', 'Postal Code'),
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_zimbra_meeting01_domain_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('domain_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_zimbra_meeting01_domain_id_search');
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $editColumn = new CustomEditColumn('Floor', 'floor', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $editor->SetMaxLength(64);
            $editColumn = new CustomEditColumn('Building', 'building', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_zimbra_meeting01_domain_id_search', 'id', 'domain', null, 20);
    ...
    try
    {
        $Page = new zimbra_meeting01Page("zimbra_meeting01", "zimbra_meeting_trash.php", GetCurrentUserPermissionSetForDataSource("zimbra_meeting01"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("zimbra_meeting01"));
