        ...
        <div style="margin: 0px 20px;">
			...
			<div class="tab-content" style="margin-top: 20px; min-height: 350px">
				<div role="tabpanel" class="tab-pane active" id="page01-{$Grid.FormId}">
					...
					{include file="custom_templates/custom_form_column.tpl" Column=$Columns.ip Help=NOME_FORM_ip}
					{include file="custom_templates/custom_form_column.tpl" Column=$Columns.port Help=NOME_FORM_port}
					{include file="custom_templates/custom_form_column.tpl" Column=$Columns.protocol Help=NOME_FORM_protocol}
					{include file="custom_templates/custom_form_column.tpl" Column=$Columns.timeout_client Help=NOME_FORM_timeout_client}
					{include file="custom_templates/custom_form_column.tpl" Column=$Columns.timeout_server Help=NOME_FORM_timeout_server}
					{include file="custom_templates/custom_form_column.tpl" Column=$Columns.option Help=NOME_FORM_option}
					{include file="custom_templates/custom_form_column.tpl" Column=$Columns.balance Help=NOME_FORM_balance}
					...
					{include file="custom_templates/custom_form_column.tpl" Column=$Columns.server_port Help=NOME_FORM_server_port}
					{include file="custom_templates/custom_form_column.tpl" Column=$Columns.maxconn Help=NOME_FORM_maxconn}
