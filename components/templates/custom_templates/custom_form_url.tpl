        ...
        <div style="margin: 0px 20px;">
			...
			<div class="tab-content" style="margin-top: 20px; min-height: 350px">
				<div role="tabpanel" class="tab-pane active" id="page01-{$Grid.FormId}">
					...
					{include file="custom_templates/custom_form_column.tpl" Column=$Columns.uri Help=NOME_FORM_uri}
					{include file="custom_templates/custom_form_column.tpl" Column=$Columns.complete_uri Help=NOME_FORM_complete_uri}

					<div class="form-title-field">{$Captions->GetMessageString('Action')}</div>
					{include file="custom_templates/custom_form_column.tpl" Column=$Columns.redirect_type Help=NOME_FORM_redirect_type}
					{include file="custom_templates/custom_form_column.tpl" Column=$Columns.poolweb_id Help=NOME_FORM_poolweb_id}
					{include file="custom_templates/custom_form_column.tpl" Column=$Columns.url Help=NOME_FORM_url}
