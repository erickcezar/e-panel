        ...
        <div style="margin: 0px 20px;">
			...
			<div class="tab-content" style="margin-top: 20px; min-height: 350px">
				<div role="tabpanel" class="tab-pane active" id="page01-{$Grid.FormId}">
					...
					{include file="custom_templates/custom_form_column.tpl" Column=$Columns.local Help=NOME_FORM_local}
					...
					{include file="custom_templates/custom_form_column.tpl" Column=$Columns.contact Help=NOME_FORM_contact}
					{include file="custom_templates/custom_form_column.tpl" Column=$Columns.email Help=NOME_FORM_email}
					{include file="custom_templates/custom_form_column.tpl" Column=$Columns.phone Help=NOME_FORM_phone}

					<div class="form-title-field">{$Captions->GetMessageString('MeetingCapacity')}</div>
					{include file="custom_templates/custom_form_column.tpl" Column=$Columns.capacity Help=NOME_FORM_capacity}
				...
				<div role="tabpanel" class="tab-pane" id="page02-{$Grid.FormId}">
					{include file="custom_templates/custom_form_column.tpl" Column=$Columns.street Help=NOME_FORM_street}
					{include file="custom_templates/custom_form_column.tpl" Column=$Columns.floor Help=NOME_FORM_floor}
					{include file="custom_templates/custom_form_column.tpl" Column=$Columns.building Help=NOME_FORM_building}
					{include file="custom_templates/custom_form_column.tpl" Column=$Columns.city Help=NOME_FORM_city}
					{include file="custom_templates/custom_form_column.tpl" Column=$Columns.state Help=NOME_FORM_state}
					{include file="custom_templates/custom_form_column.tpl" Column=$Columns.postal_code Help=NOME_FORM_postal_code}
					{include file="custom_templates/custom_form_column.tpl" Column=$Columns.country Help=NOME_FORM_country}
				</div>
			</div>		  
        </div>
    </div>
