...
<div class="column-filter">
    ...
    <div class="btn-toolbar pull-right">
        <button type="reset" class="btn btn-cancel js-reset">{$Captions->getMessageString('ResetAdvancedFilter')}</button>
        <button type="submit" class="btn btn-primary js-apply">{$Captions->getMessageString('ApplyAdvancedFilter')}</button>
    </div>
</div>
</script>
