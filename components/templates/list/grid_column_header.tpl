<th
    ...
    {if $childDepth == 0}
        ...
        {/if}
        data-field-caption="{$Captions->GetMessageString($child->getCaption())}"
        ...
        {/if}
        {if $child->getDescription()}data-comment="{$Captions->GetMessageString($child->GetDescription())}"{/if}>
    ...
    {strip}
        <span{if $childDepth == 0 and $child->getDescription()} class="commented"{/if}>{$Captions->GetMessageString($child->getCaption())}</span>
