    ...
    <div class="modal-dialog">
        <div class="modal-content">
                            ...
                            <tr class="sorting-level">
                                ...
                                <td>
                                    ...
                                    {foreach from=$SortableHeaders item="value" key="key"}
                                        <option value="{$key}" {if ($Level->getFieldName() == $key)} selected{/if}>{$Captions->GetMessageString($value.caption)}</option>
                                    {/foreach}
                                    </select>
                                </td>
                                <td>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-cancel" data-dismiss="modal">{$Captions->GetMessageString('Cancel')}</button>
