 ...
 */
    ...
    class zimbra_account01Page extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('TitleZimbraAccountTrash');
            $this->SetMenuLabel('LabelZimbraAccountTrash');
            ...
            $this->dataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), '(`zimbra_account`.`deleted` = 1)'));
        }
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'preauth_authentication', 'preauth_authentication', 'Preauth Authentication'),
                new FilterColumn($this->dataset, 'preauth_password', 'preauth_password', 'Preauth Password'),
                new FilterColumn($this->dataset, 'preauth_password_must_change', 'preauth_password_must_change', 'Preauth Password Must Change'),
                new FilterColumn($this->dataset, 'preauth_password_locked', 'preauth_password_locked', 'Preauth Password Locked'),
                new FilterColumn($this->dataset, 'preauth_password_expire', 'preauth_password_expire', 'Preauth Password Expire'),
                new FilterColumn($this->dataset, 'preauth_password_expire_time', 'preauth_password_expire_time', 'Preauth Password Expire Time'),
                new FilterColumn($this->dataset, 'preauth_password_modified_time', 'preauth_password_modified_time', 'Preauth Password Modified Time'),
                new FilterColumn($this->dataset, 'preauth_last_login_time', 'preauth_last_login_time', 'Preauth Last Login Time'),
                new FilterColumn($this->dataset, 'preauth_restrict_login', 'preauth_restrict_login', 'Preauth Restrict Login'),
                new FilterColumn($this->dataset, 'preauth_access_other_account', 'preauth_access_other_account', 'Preauth Access Other Account'),
                new FilterColumn($this->dataset, 'zimbra_authentication', 'zimbra_authentication', 'Zimbra Authentication'),
                new FilterColumn($this->dataset, 'zimbra_password', 'zimbra_password', 'Zimbra Password'),
                new FilterColumn($this->dataset, 'zimbra_password_must_change', 'zimbra_password_must_change', 'Zimbra Password Must Change'),
                new FilterColumn($this->dataset, 'zimbra_password_locked', 'zimbra_password_locked', 'Zimbra Password Locked'),
                new FilterColumn($this->dataset, 'zimbra_password_expire', 'zimbra_password_expire', 'Zimbra Password Expire'),
                new FilterColumn($this->dataset, 'zimbra_password_expire_time', 'zimbra_password_expire_time', 'Zimbra Password Expire Time'),
                new FilterColumn($this->dataset, 'zimbra_password_modified_time', 'zimbra_password_modified_time', 'Zimbra Password Modified Time'),
                new FilterColumn($this->dataset, 'zimbra_last_login_time', 'zimbra_last_login_time', 'Zimbra Last Login Time'),
                new FilterColumn($this->dataset, 'zimbra_pop3', 'zimbra_pop3', 'Zimbra Pop3'),
                new FilterColumn($this->dataset, 'zimbra_imap', 'zimbra_imap', 'Zimbra Imap'),
                new FilterColumn($this->dataset, 'zimbra_pop3_include_spam', 'zimbra_pop3_include_spam', 'Zimbra Pop3 Include Spam'),
                new FilterColumn($this->dataset, 'zimbra_hide_of_contacts', 'zimbra_hide_of_contacts', 'Zimbra Hide Of Contacts'),
                new FilterColumn($this->dataset, 'zimbra_auto_reply', 'zimbra_auto_reply', 'Zimbra Auto Reply'),
                new FilterColumn($this->dataset, 'zimbra_auto_reply_message', 'zimbra_auto_reply_message', 'Zimbra Auto Reply Message'),
                new FilterColumn($this->dataset, 'zimbra_auto_reply_time_start', 'zimbra_auto_reply_time_start', 'Zimbra Auto Reply Time Start'),
                new FilterColumn($this->dataset, 'zimbra_auto_reply_time_stop', 'zimbra_auto_reply_time_stop', 'Zimbra Auto Reply Time Stop'),
                new FilterColumn($this->dataset, 'zimbra_mail_forwarding_address', 'zimbra_mail_forwarding_address', 'Zimbra Mail Forwarding Address'),
                new FilterColumn($this->dataset, 'zimbra_forward_local_copy', 'zimbra_forward_local_copy', 'Zimbra Forward Local Copy'),
                new FilterColumn($this->dataset, 'zimbra_id', 'zimbra_id', 'Zimbra Id'),
                new FilterColumn($this->dataset, 'conf_password_min_length', 'conf_password_min_length', 'Conf Password Min Length'),
                new FilterColumn($this->dataset, 'conf_password_max_length', 'conf_password_max_length', 'Conf Password Max Length'),
                new FilterColumn($this->dataset, 'conf_password_min_upper_case_chars', 'conf_password_min_upper_case_chars', 'Conf Password Min Upper Case Chars'),
                new FilterColumn($this->dataset, 'conf_password_min_lower_case_chars', 'conf_password_min_lower_case_chars', 'Conf Password Min Lower Case Chars'),
                new FilterColumn($this->dataset, 'conf_password_min_numeric_chars', 'conf_password_min_numeric_chars', 'Conf Password Min Numeric Chars'),
                new FilterColumn($this->dataset, 'conf_password_min_digits_or_puncs', 'conf_password_min_digits_or_puncs', 'Conf Password Min Digits Or Puncs'),
                new FilterColumn($this->dataset, 'conf_password_min_punctuation_chars', 'conf_password_min_punctuation_chars', 'Conf Password Min Punctuation Chars'),
                new FilterColumn($this->dataset, 'conf_password_min_age', 'conf_password_min_age', 'Conf Password Min Age'),
                new FilterColumn($this->dataset, 'conf_password_max_age', 'conf_password_max_age', 'Conf Password Max Age'),
                new FilterColumn($this->dataset, 'account_system', 'account_system', 'Account System'),
        ...
        protected function setupQuickFilter(QuickFilter $quickFilter, FixedKeysArray $columns)
        {
            $quickFilter
                ...
                ->addColumn($columns['preauth_password_modified_time'])
                ...
                ->addColumn($columns['zimbra_password_modified_time'])
                ->addColumn($columns['zimbra_last_login_time'])
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_zimbra_account01_domain_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('domain_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_zimbra_account01_domain_id_search');
            ...
            $main_editor = new TextEdit('preauth_authentication_edit');
            ...
            $main_editor = new TextEdit('preauth_password_edit');
            $main_editor->SetMaxLength(64);
            ...
            $main_editor = new TextEdit('preauth_password_must_change_edit');
            ...
            $main_editor = new TextEdit('preauth_password_locked_edit');
            ...
            $main_editor = new TextEdit('preauth_password_expire_edit');
            ...
            $main_editor = new DateTimeEdit('preauth_password_modified_time_edit', false, 'Y-m-d H:i');
            
            $filterBuilder->addColumn(
                $columns['preauth_password_modified_time'],
                array(
                    FilterConditionOperator::EQUALS => $main_editor,
                    FilterConditionOperator::DOES_NOT_EQUAL => $main_editor,
                    FilterConditionOperator::IS_GREATER_THAN => $main_editor,
            ...
            $main_editor = new TextEdit('preauth_restrict_login_edit');
            ...
            $main_editor = new TextEdit('preauth_access_other_account_edit');
            ...
            $main_editor = new TextEdit('zimbra_authentication_edit');
            ...
            $main_editor = new TextEdit('zimbra_password_edit');
            $main_editor->SetMaxLength(128);
            ...
            $main_editor = new TextEdit('zimbra_password_must_change_edit');
            ...
            $main_editor = new TextEdit('zimbra_password_locked_edit');
            ...
            $main_editor = new TextEdit('zimbra_password_expire_edit');
            ...
            $main_editor = new DateTimeEdit('zimbra_password_modified_time_edit', false, 'Y-m-d H:i');
            
            $filterBuilder->addColumn(
                $columns['zimbra_password_modified_time'],
                array(
                    FilterConditionOperator::EQUALS => $main_editor,
                    FilterConditionOperator::DOES_NOT_EQUAL => $main_editor,
                    FilterConditionOperator::IS_GREATER_THAN => $main_editor,
            ...
            $main_editor = new DateTimeEdit('zimbra_last_login_time_edit', false, 'Y-m-d H:i');
            
            $filterBuilder->addColumn(
                $columns['zimbra_last_login_time'],
                array(
                    FilterConditionOperator::EQUALS => $main_editor,
                    FilterConditionOperator::DOES_NOT_EQUAL => $main_editor,
                    FilterConditionOperator::IS_GREATER_THAN => $main_editor,
            ...
            $main_editor = new TextEdit('zimbra_pop3_edit');
            ...
            $main_editor = new TextEdit('zimbra_imap_edit');
            ...
            $main_editor = new TextEdit('zimbra_pop3_include_spam_edit');
            ...
            $main_editor = new TextEdit('zimbra_hide_of_contacts_edit');
            ...
            $main_editor = new TextEdit('zimbra_auto_reply_edit');
            ...
            $main_editor = new TextEdit('zimbra_forward_local_copy_edit');
            ...
            $main_editor = new TextEdit('account_system_edit');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            $column->SetFullTextWindowHandlerName('zimbra_account01_name_handler_list');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('Nome do usuário da conta');
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('Data da exclusão da conta');
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        }
        ...
        protected function doRegisterHandlers() {
            ...
            $column->SetOrderable(true);
            $column->setAlign('left');
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'zimbra_account01_name_handler_list', $column);
            ...
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_zimbra_account01_domain_id_search', 'id', 'domain', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    try
    {
        $Page = new zimbra_account01Page("zimbra_account01", "zimbra_account_trash.php", GetCurrentUserPermissionSetForDataSource("zimbra_account01"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("zimbra_account01"));
