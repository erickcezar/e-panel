 ...
 */
    ...
    class zimbra_list01Page extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('TitleZimbraListTrash');
            $this->SetMenuLabel('LabelZimbraListTrash');
            ...
            $this->dataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), '(`zimbra_list`.`deleted` = 1)'));
        }
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_zimbra_list01_domain_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('domain_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_zimbra_list01_domain_id_search');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            $column->setAlign('left');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('Nome da lista');
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        protected function doRegisterHandlers() {
            ...
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_zimbra_list01_domain_id_search', 'id', 'domain', null, 20);
    ...
    try
    {
        $Page = new zimbra_list01Page("zimbra_list01", "zimbra_list_trash.php", GetCurrentUserPermissionSetForDataSource("zimbra_list01"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("zimbra_list01"));
