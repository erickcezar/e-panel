 ...
 */
    ...
    class zimbra_alias01Page extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('TitleZimbraAliasTrash');
            $this->SetMenuLabel('LabelZimbraAliasTrash');
            ...
            $this->dataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), '(`zimbra_alias`.`deleted` = 1)'));
        }
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_zimbra_alias01_account_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('account_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_zimbra_alias01_account_id_search');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            $column->SetFullTextWindowHandlerName('zimbra_alias01_alias_handler_list');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('');
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('Data da exclusão do registro');
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        }
        ...
        protected function doRegisterHandlers() {
            ...
            $column->SetOrderable(true);
            $column->setAlign('left');
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'zimbra_alias01_alias_handler_list', $column);
            ...
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_zimbra_alias01_account_id_search', 'id', 'username', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    try
    {
        $Page = new zimbra_alias01Page("zimbra_alias01", "zimbra_alias_trash.php", GetCurrentUserPermissionSetForDataSource("zimbra_alias01"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("zimbra_alias01"));
