 ...
 */
    ...
    class url_user_domain_idNestedPage extends NestedFormPage
    {
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('caption_client_id', 'client_id', 'client_id_name', 'insert_url_user_domain_idNestedPage_client_id_search', $editor, $this->dataset, $lookupDataset, 'id', 'name', '');
    ...
    class url_userPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('TitleAuthUrlUser');
            $this->SetMenuLabel('LabelAuthUrlUser');
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_url_user_domain_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('domain_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_url_user_domain_id_search');
            ...
            $main_editor = new DateTimeEdit('expire_edit', false, 'Y-m-d');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            $column->SetFullTextWindowHandlerName('url_user_description_handler_list');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('url_user_description_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('caption_domain_id', 'domain_id', 'domain_id_domain', 'edit_url_user_domain_id_search', $editor, $this->dataset, $lookupDataset, 'id', 'domain', '');
            $editColumn->setNestedInsertFormLink(
                $this->GetHandlerLink(url_user_domain_idNestedPage::getNestedInsertHandlerName())
            );
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            //
            $editor = new DateTimeEdit('expire_edit', false, 'Y-m-d');
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('domain', 'ASC');
            $editColumn = new DynamicLookupEditColumn('caption_domain_id', 'domain_id', 'domain_id_domain', 'multi_edit_url_user_domain_id_search', $editor, $this->dataset, $lookupDataset, 'id', 'domain', '');
            $editColumn->setNestedInsertFormLink(
                $this->GetHandlerLink(url_user_domain_idNestedPage::getNestedInsertHandlerName())
            );
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('domain', 'ASC');
            $editColumn = new DynamicLookupEditColumn('caption_domain_id', 'domain_id', 'domain_id_domain', 'insert_url_user_domain_id_search', $editor, $this->dataset, $lookupDataset, 'id', 'domain', '');
            $editColumn->setNestedInsertFormLink(
                $this->GetHandlerLink(url_user_domain_idNestedPage::getNestedInsertHandlerName())
            );
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
        ...
        protected function AddPrintColumns(Grid $grid)
        {
            ...
            $column->setAlign('left');
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('url_user_description_handler_print');
            $grid->AddPrintColumn($column);
        ...
        protected function AddExportColumns(Grid $grid)
        {
            ...
            $column->setAlign('left');
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('url_user_description_handler_export');
            $grid->AddExportColumn($column);
        ...
        private function AddCompareColumns(Grid $grid)
        {
            ...
            $column->setAlign('left');
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('url_user_description_handler_compare');
            $grid->AddCompareColumn($column);
        ...
        protected function doRegisterHandlers() {
            ...
            $column->SetOrderable(true);
            $column->setAlign('left');
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'url_user_description_handler_list', $column);
            ...
            $column->SetOrderable(true);
            $column->setAlign('left');
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'url_user_description_handler_print', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column->SetOrderable(true);
            $column->setAlign('left');
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'url_user_description_handler_compare', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('domain', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_url_user_domain_id_search', 'id', 'domain', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('domain', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_url_user_domain_id_search', 'id', 'domain', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('description', 'description', 'caption_description', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'url_user_description_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('domain', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_url_user_domain_id_search', 'id', 'domain', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('domain', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_url_user_domain_id_search', 'id', 'domain', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            $lookupDataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_url_user_domain_idNestedPage_client_id_search', 'id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            
            
            new url_user_domain_idNestedPage($this, GetCurrentUserPermissionSetForDataSource('url_user.domain_id'));
        }
    ...
    try
    {
        $Page = new url_userPage("url_user", "url_user.php", GetCurrentUserPermissionSetForDataSource("url_user"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("url_user"));
