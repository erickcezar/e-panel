...
?><?php echo ''; ?><?php $this->assign('operators', $this->_tpl_vars['DataGrid']['FilterBuilder']->getOperators($this->_tpl_vars['column'])); ?><?php echo ''; ?><?php echo '
            gridData.filterBuilder.columns.push({
                '; ?><?php echo 'fieldName: \''; ?><?php echo ((is_array($_tmp=$this->_tpl_vars['column']->getFieldName())) ? $this->_run_mod_handler('escape', true, $_tmp, 'quotes') : smarty_modifier_escape($_tmp, 'quotes')); ?><?php echo '\',caption: \''; ?><?php echo ((is_array($_tmp=$this->_tpl_vars['Captions']->GetMessageString($this->_tpl_vars['column']->getCaption()))) ? $this->_run_mod_handler('escape', true, $_tmp, 'quotes') : smarty_modifier_escape($_tmp, 'quotes')); ?><?php echo '\',operators: '; ?><?php echo smarty_function_to_json(array('value' => array_keys($this->_tpl_vars['operators'])), $this);?><?php echo ''; ?><?php echo '
            });
...
?><?php echo ''; ?><?php echo '
            gridData.columnFilter.columns.push({
                ...
                caption: '; ?><?php echo '\''; ?><?php echo ((is_array($_tmp=$this->_tpl_vars['Captions']->GetMessageString($this->_tpl_vars['column']->getCaption()))) ? $this->_run_mod_handler('escape', true, $_tmp, 'quotes') : smarty_modifier_escape($_tmp, 'quotes')); ?><?php echo '\''; ?><?php echo ',
