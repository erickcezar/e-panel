...
?>
            <?php if ($this->_tpl_vars['value'] !== ''): ?>
                <option value="<?php echo $this->_tpl_vars['value']; ?>
"<?php if ($this->_tpl_vars['Editor']->getValue() == $this->_tpl_vars['value']): ?> selected<?php endif; ?>><?php echo $this->_tpl_vars['Captions']->GetMessageString($this->_tpl_vars['displayValue']); ?>
</option>
            <?php endif; ?>
        <?php endforeach; endif; unset($_from); ?>
    </select>
