                ...
                <div class="dropdown-menu dropdown-menu-right" role="menu">
                    <form class="form-horizontal quick-filter">
                        <div class="form-group">
                            ...
                            <div class="col-input" style="width:100%;max-width:100%" data-column="quick_filter_fields">
...
" <?php if (((is_array($_tmp=$this->_tpl_vars['column']->getFieldName())) ? $this->_run_mod_handler('in_array', true, $_tmp, $this->_tpl_vars['filter']->getSelectedFieldNames()) : in_array($_tmp, $this->_tpl_vars['filter']->getSelectedFieldNames()))): ?> selected<?php endif; ?>><?php echo $this->_tpl_vars['Captions']->GetMessageString($this->_tpl_vars['column']->getCaption()); ?>
</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-input" style="width:100%;max-width:100%" data-column="quick_filter_operator">
...
" <?php if ($this->_tpl_vars['operator'] == $this->_tpl_vars['filter']->getOperator()): ?> selected<?php endif; ?>>
                        ...
                        <span class="pull-right">
                            <button type="button" class="js-cancel btn btn-cancel"><?php echo $this->_tpl_vars['Captions']->GetMessageString('Cancel'); ?>
</button>
                            <button type="button" class="js-submit btn btn-primary"><?php echo $this->_tpl_vars['Captions']->GetMessageString('Apply'); ?>
</button>
                        </span>
                    </form>
                </div>
