...
">
    ...
    <div class="btn-toolbar pull-right">
        <button type="reset" class="btn btn-cancel js-reset"><?php echo $this->_tpl_vars['Captions']->getMessageString('ResetAdvancedFilter'); ?>
</button>
        <button type="submit" class="btn btn-primary js-apply"><?php echo $this->_tpl_vars['Captions']->getMessageString('ApplyAdvancedFilter'); ?>
</button>
    </div>
</div>
</script>