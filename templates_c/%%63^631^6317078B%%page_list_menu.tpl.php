...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escapeurl', 'page_list_menu.tpl', 21, false),)), $this); ?>
        ...
        <?php if ($this->_tpl_vars['GroupCaption'] != 'Default'): ?>
            <li class="dropdown">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                    <?php echo $this->_tpl_vars['Captions']->GetMessageString($this->_tpl_vars['GroupCaption']); ?>
...
" title="<?php echo $this->_tpl_vars['Captions']->GetMessageString($this->_tpl_vars['PageListPage']['Hint']); ?>
"<?php if ($this->_tpl_vars['PageListPage']['Target']): ?> target="<?php echo $this->_tpl_vars['PageListPage']['Target']; ?>
"<?php endif; ?>>
                        <?php echo $this->_tpl_vars['Captions']->GetMessageString($this->_tpl_vars['PageListPage']['Caption']); ?>
