...
;"
        <?php endif; ?>
        data-field-caption="<?php echo $this->_tpl_vars['Captions']->GetMessageString($this->_tpl_vars['child']->getCaption()); ?>
"
...
"
        ...
        <?php endif; ?>
        <?php if ($this->_tpl_vars['child']->getDescription()): ?>data-comment="<?php echo $this->_tpl_vars['Captions']->GetMessageString($this->_tpl_vars['child']->GetDescription()); ?>
"<?php endif; ?>>
