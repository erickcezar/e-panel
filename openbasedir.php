 ...
 */
    ...
    class openbasedirPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('TitleOpenBaseDir');
            $this->SetMenuLabel('LabelOpenBaseDir');
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'path', 'path', 'caption_path'),
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            $column = new TextViewColumn('path', 'path', 'caption_path', $this->dataset);
            $column->SetOrderable(true);
            $column->setAlign('left');
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('openbasedir_path_handler_list');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('header_hint_path');
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('openbasedir_path_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new CustomEditColumn('caption_path', 'path', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $validator = new CustomRegExpValidator('^/((\{ROOTDIR\})?[a-zA-Z0-9:/_.-]+)+)$', StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RegExpValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        }
        ...
        protected function AddPrintColumns(Grid $grid)
        {
            ...
            $column->setAlign('left');
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('openbasedir_path_handler_print');
            $grid->AddPrintColumn($column);
        ...
        protected function AddExportColumns(Grid $grid)
        {
            ...
            $column->setAlign('left');
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('openbasedir_path_handler_export');
            $grid->AddExportColumn($column);
        ...
        private function AddCompareColumns(Grid $grid)
        {
            ...
            $column->setAlign('left');
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('openbasedir_path_handler_compare');
            $grid->AddCompareColumn($column);
        ...
        protected function doRegisterHandlers() {
            ...
            $column->SetOrderable(true);
            $column->setAlign('left');
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'openbasedir_path_handler_list', $column);
            ...
            $column->SetOrderable(true);
            $column->setAlign('left');
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'openbasedir_path_handler_print', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column->SetOrderable(true);
            $column->setAlign('left');
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'openbasedir_path_handler_compare', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('path', 'path', 'caption_path', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'openbasedir_path_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    try
    {
        $Page = new openbasedirPage("openbasedir", "openbasedir.php", GetCurrentUserPermissionSetForDataSource("openbasedir"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("openbasedir"));
