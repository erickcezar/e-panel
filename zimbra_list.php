 ...
 */
    ...
    class zimbra_list_domain_idNestedPage extends NestedFormPage
    {
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('caption_client_id', 'client_id', 'client_id_name', 'insert_zimbra_list_domain_idNestedPage_client_id_search', $editor, $this->dataset, $lookupDataset, 'id', 'name', '');
    ...
    class zimbra_listPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('TitleZimbraList');
            $this->SetMenuLabel('LabelZimbraList');
            ...
            $this->dataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), '(`zimbra_list`.`deleted` = 0)'));
        }
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_zimbra_list_domain_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('domain_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_zimbra_list_domain_id_search');
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetFullTextWindowHandlerName('zimbra_list_description_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('caption_domain_id', 'domain_id', 'domain_id_domain', 'edit_zimbra_list_domain_id_search', $editor, $this->dataset, $lookupDataset, 'id', 'domain', '');
            $editColumn->setNestedInsertFormLink(
                $this->GetHandlerLink(zimbra_list_domain_idNestedPage::getNestedInsertHandlerName())
            );
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('domain', 'ASC');
            $editColumn = new DynamicLookupEditColumn('caption_domain_id', 'domain_id', 'domain_id_domain', 'multi_edit_zimbra_list_domain_id_search', $editor, $this->dataset, $lookupDataset, 'id', 'domain', '');
            $editColumn->setNestedInsertFormLink(
                $this->GetHandlerLink(zimbra_list_domain_idNestedPage::getNestedInsertHandlerName())
            );
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('domain', 'ASC');
            $editColumn = new DynamicLookupEditColumn('caption_domain_id', 'domain_id', 'domain_id_domain', 'insert_zimbra_list_domain_id_search', $editor, $this->dataset, $lookupDataset, 'id', 'domain', '');
            $editColumn->setNestedInsertFormLink(
                $this->GetHandlerLink(zimbra_list_domain_idNestedPage::getNestedInsertHandlerName())
            );
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
        ...
        protected function AddPrintColumns(Grid $grid)
        {
            ...
            $column->setAlign('left');
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('zimbra_list_description_handler_print');
            $grid->AddPrintColumn($column);
        ...
        protected function AddExportColumns(Grid $grid)
        {
            ...
            $column->setAlign('left');
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('zimbra_list_description_handler_export');
            $grid->AddExportColumn($column);
        ...
        private function AddCompareColumns(Grid $grid)
        {
            ...
            $column->setAlign('left');
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('zimbra_list_description_handler_compare');
            $grid->AddCompareColumn($column);
        ...
        protected function doRegisterHandlers() {
            ...
            $column->SetOrderable(true);
            $column->setAlign('left');
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'zimbra_list_description_handler_print', $column);
            ...
            $column->SetOrderable(true);
            $column->setAlign('left');
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'zimbra_list_description_handler_compare', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('domain', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_zimbra_list_domain_id_search', 'id', 'domain', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('domain', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_zimbra_list_domain_id_search', 'id', 'domain', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('description', 'description', 'caption_description', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'zimbra_list_description_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('domain', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_zimbra_list_domain_id_search', 'id', 'domain', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('domain', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_zimbra_list_domain_id_search', 'id', 'domain', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            $lookupDataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_zimbra_list_domain_idNestedPage_client_id_search', 'id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            
            
            new zimbra_list_domain_idNestedPage($this, GetCurrentUserPermissionSetForDataSource('zimbra_list.domain_id'));
        }
    ...
    try
    {
        $Page = new zimbra_listPage("zimbra_list", "zimbra_list.php", GetCurrentUserPermissionSetForDataSource("zimbra_list"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("zimbra_list"));
