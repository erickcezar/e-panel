 ...
 */
    ...
    class zimbra_mail01Page extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('TitleZimbraMailTrash');
            $this->SetMenuLabel('LabelZimbraMailTrash');
            ...
            $this->dataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), '(`zimbra_mail`.`deleted` = 1)'));
        }
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_zimbra_mail01_account_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('account_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_zimbra_mail01_account_id_search');
            ...
            $main_editor->addChoice('allow', 'allow');
            $main_editor->addChoice('deny', 'deny');
            $main_editor->addChoice('trusted', 'trusted');
            $main_editor->SetAllowNullValue(false);
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            $column->SetFullTextWindowHandlerName('zimbra_mail01_email_handler_list');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('');
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        protected function doRegisterHandlers() {
            ...
            $column->SetOrderable(true);
            $column->setAlign('left');
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'zimbra_mail01_email_handler_list', $column);
            ...
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_zimbra_mail01_account_id_search', 'id', 'username', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    try
    {
        $Page = new zimbra_mail01Page("zimbra_mail01", "zimbra_mail_trash.php", GetCurrentUserPermissionSetForDataSource("zimbra_mail01"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("zimbra_mail01"));
